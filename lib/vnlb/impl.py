...
def denoise_mod(noisy, sigma, flows=None, gpuid=0, clean=None, verbose=True):
    ...
    # params['stype'] = ["l2","l2"]
    params.sizeSearchTimeBwd[0] = 20
    params.sizeSearchTimeFwd[0] = 20
    ...
    for i in range(nsteps):
        ...
        params['nSimilarPatches'][0] = 2+2*i
        params['cpatches'][0] = "noisy"
        params['srch_img'][0] = "basic"
        params['deno'][0] = "bayes"
        params['nkeep'][0] = 1
        params.sizeSearchTimeBwd[0] = 20#10+3*i
        params.sizeSearchTimeFwd[0] = 20#10+3*i
        params.sizeSearchWindow[0] = 10#-i
    ...
    # -- [step 3] --
    params['stype'] = ["needle","l2"]
    params.sizeSearchTimeBwd[1] = 20
    params.sizeSearchTimeFwd[1] = 20
